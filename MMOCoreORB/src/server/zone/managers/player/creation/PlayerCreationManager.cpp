...
bool PlayerCreationManager::createCharacter(ClientCreateCharacterCallback* callback) const {
	...
	chatManager->sendMail("system", "Welcome to Aftermath!", "Welcome to Aftermath! This game mail is meant to give you a quick welcome and overview. If you need additional details on anything about the game, don't be afraid to bring up the Holocron (default: CTRL H). You can also utilise the ‘general’ chat tab to talk to the entire server. This in game general chat is linked to our Discord general chat server. These two combined chat channels are the central hub of communication for Aftermath. If you ever feel the need to ask for help, you’ll usually find someone in these channels who can help you. As mentioned above, our Discord chat is the central hub of communication on Aftermath. If you have a Discord account or have an interest in joining Discord, we highly recommend you join the Aftermath Discord server via the link on the Aftermath website. We have multiple sections for players to use including trading, recruitment and support, as well as bots that let you set special faction roles for yourself to show players what faction you will be representing on Aftermath. If you don’t want to join the Discord, that’s okay. You can use the in game general chat to take part in the conversations just as easily! If you are looking for a little direction to get started, we recommend starting on either Coronet on Corellia, Theed on Naboo or Mos Eisley on Tatooine. These cities have small critters on the outskirts that are killable by new players for some good starter XP. Every city has an enhancement terminal that will give out weak starter buffs for a cheap cost, so no matter where you start you can get a little boost in power. Aftermath also has many player cities run by different players. We encourage new players to check them out. Some players hang out exclusively in player cities, and you can find many different services in each city. Your best source for in-depth information on the game will come from other players. The best source for this is our ‘general’ chat rooms in Discord and in game. We have a bunch of helpful people on Aftermath that are always willing to help new players get to grips with the game and server. If you’re looking to purchase new items on the in game Bazaar terminals, make sure you filter to ‘vendor location’ and ‘entire galaxy’ via the tabs in the top left of the UI screen. This will show all player vendors on the server selling their wares. You can also purchase items through the ‘trade’ channel in Discord and see players advertising their items in the ‘auction’ chat room in game. On behalf of the Aftermath team, thank you and enjoy your time in Star Wars Galaxies Aftermath. May the Force be with you.", playerCreature->getFirstName());
