	...
	for (int i = 0; i < ghost->getActivePetsSize(); ++i) {
		...
		if (object != nullptr) {
			if (object->isCreature() && petType == PetManager::CREATUREPET) {
				...
				if (activePetTemplate == nullptr || activePetTemplate->getTemplateName() == "at_st" || activatePetTemplate->getTemplateName() == "at_xt")
					continue;
				...
				if (activePetTemplate == nullptr || callingPetTemplate == nullptr || activePetTemplate->getTemplateName() != "at_st" || activatePetTemplate->getTemplateName() != "at_xt")
					continue;
