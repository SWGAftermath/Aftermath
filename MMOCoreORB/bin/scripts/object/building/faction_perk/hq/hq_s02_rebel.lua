...
object_building_faction_perk_hq_hq_s02_rebel = object_building_faction_perk_hq_shared_hq_s02_rebel:new {
	...
	childObjects = {
		...
		{ templateFile = "object/installation/faction_perk/covert_detector/detector_base.iff", x = 0, z = 0, y = 39.5, ox = 0, oy = .7, oz = 0, ow = .7, cellid=-1, containmentType = -1 },
	...
	childCreatureObjects = {
		...
		{ mobile="at_xt", x=0, z=0, y=52, cellid=-1, respawn=720, containmentType=-1, heading=0},
