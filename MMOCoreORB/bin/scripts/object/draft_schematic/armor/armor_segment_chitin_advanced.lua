...
object_draft_schematic_armor_armor_segment_chitin_advanced = object_draft_schematic_armor_shared_armor_segment_chitin_advanced:new {
    ...
    resourceTypes = {"bone_mammal_dantooine", "iron_doonium", "copper_desh", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_armor_layer.iff", "object/tangible/component/armor/shared_base_armor_segment_enhancement.iff"},
    resourceQuantities = {5, 16, 8, 1, 1, 1, 1},
