...
object_draft_schematic_structure_bespin_house_schem = object_draft_schematic_structure_shared_bespin_house_schem:new {

   templateType = DRAFTSCHEMATIC,

   --customObjectName = "Deed for: Bespin Cloud House",
   ...
   targetTemplate = "object/tangible/deed/player_house_deed/bespin_house_deed.iff",

   additionalTemplates = {}

}
ObjectTemplates:addTemplate(object_draft_schematic_structure_bespin_house_schem, "object/draft_schematic/structure/bespin_house_schem.iff")
