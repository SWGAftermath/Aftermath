...
object_draft_schematic_item_shared_sea_removal_tool = SharedDraftSchematicObjectTemplate:new {
	clientTemplateFileName = "object/draft_schematic/item/shared_sea_removal_tool.iff"
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "",
	arrangementDescriptorFilename = "abstract/slot/arrangement/arrangement_datapad.iff",
...
ObjectTemplates:addClientTemplate(object_draft_schematic_item_shared_sea_removal_tool, "object/draft_schematic/item/shared_sea_removal_tool.iff")
