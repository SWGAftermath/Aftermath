...
object_tangible_component_armor_armor_segment_padded_advanced = object_tangible_component_armor_shared_armor_segment_padded_advanced:new {
...
ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_padded_advanced, "object/tangible/component/armor/armor_segment_padded_advanced.iff")