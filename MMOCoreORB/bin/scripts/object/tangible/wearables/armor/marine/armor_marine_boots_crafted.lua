...
ObjectTemplates:addTemplate(object_tangible_wearables_armor_marine_armor_marine_boots_crafted, "object/tangible/wearables/armor/marine/armor_marine_boots_crafted.iff")
