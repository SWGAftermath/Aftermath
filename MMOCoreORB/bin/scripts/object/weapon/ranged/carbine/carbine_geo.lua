...
object_weapon_ranged_carbine_carbine_geo = object_weapon_ranged_carbine_shared_carbine_geo:new {
	...
	certificationsRequired = { "cert_carbine_geo" },
	...
	experimentalMin = {0, 0, 33, 65, 5.6, 10, 30, 750, -20, -80, 22, -5, 33, 52, 25},
	experimentalMax = {0, 0, 98, 191, 3.3, 20, 65, 1500, -20, -80, 22, 5, 18, 28, 13},
