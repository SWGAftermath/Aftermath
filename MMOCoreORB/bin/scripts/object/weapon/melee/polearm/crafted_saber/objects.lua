...
ObjectTemplates:addClientTemplate(object_weapon_melee_polearm_crafted_saber_shared_sword_lightsaber_pike_s1_gen4, "object/weapon/melee/polearm/crafted_saber/shared_sword_lightsaber_pike_s1_gen4.iff")
