...
imperialRewardData = {
	...
	weaponsArmor = {
		...
		armor_stormtrooper_chest_plate = { type=factionRewardType.armor, display="@wearables_name:armor_stormtrooper_chest_plate", item="object/tangible/loot/loot_schematic/stormtrooper_chest_plate_crafted_schematic.iff.iff", cost=20000},
