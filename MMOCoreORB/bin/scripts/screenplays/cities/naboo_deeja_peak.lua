...
function NabooDeejaPeakScreenPlay:spawnMobiles()
	...
	self:setMoodString(pNpc, "npc_sitting_chair")
	pNpc = spawnMobile("naboo", "commoner_old",60,-18.0,3.2,17.8,-45,1945395)
	self:setMoodString(pNpc, "npc_sitting_chair")
	...
	spawnMobile("naboo", "trainer_musician", 0,21.7,2.1,76.3,180,2725360)
	spawnMobile("naboo", "theater_manager", 0,21.8956,2.12814,63.5,0,2725360)
	...
	spawnMobile("naboo", "trainer_basebuster",0, 4963.78, 360, -1575.25, 221, 0)
